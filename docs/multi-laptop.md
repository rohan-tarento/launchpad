...
```bash
pipx install --force "launchpad @ git+https://github.com/drivestream-lab/launchpad@v0.5.10"
...
```bash
cat ~/Workspace/stratum/stratum-meta/.launchpad-version   # should be 0.5.10
launchpad --version                                        # launchpad 0.5.10
```
