...
def run_apply(
    ...
    *,
    ...
    print(f"  1. Register client + token — {ENV_D_DIR / (client_id + '.env')}; launchpad doctor")
    ...
    print(f"  5. launchpad --client {client_id} verify-harness-meta")
    print(f"  6. PM: commit + PR local meta → {ctx.meta_repo}/develop")
    print(f"  7. Dev: launchpad scaffold-app --repo <app> --apply --force; sync-harness-app --apply")
