...
| Layer | Blocks | Script |
|-------|--------|--------|
| **Ruleset** `branch-naming-standard` | Push/create of badly named branches (`creation` + `update`) | Deploy manually — see [github-enforcement.md](../github/github-enforcement.md) |
...
See [github-enforcement.md](../github/github-enforcement.md) and [teams-and-rbac.md](teams-and-rbac.md).
